...
NFFT = 2048
segment_size = int(2e6)   # Tamaño del segmento a analizar
c_map = 'viridis'
...
nombres_drones = [
    ...
    "matrice 300", "phantom 4 pro RTK", "matrice 30 T", "avata", "chino"]

# Loop de archivos
for i in range(8, 9):  # Modifica el rango según los archivos que quieras procesar
...
# Crear malla para 3D
T, F = np.meshgrid(t, f / 1e9)  # Frecuencia en GHz como en tu gráfico 2D
...
ax.set_title(f'Espectrograma 3D - {nombres_drones[i]} 2.4 GHz')
